...
export ACQ_LOG_TIMELINE="$ACQ_APP_DIR/$LOG_DIR_NAME/timeline"
...
export APACHE_LOG_EXPIRE=14
export NGINX_LOG_EXPIRE=14
export TOMCAT_LOG_EXPIRE=14
export ACQ_LOG_EXPIRE=14
export SERVING_LOG_EXPIRE=14
export OPTOUT_LOG_EXPIRE=14
